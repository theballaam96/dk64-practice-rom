...
wrinkly = [
    ...
    [
        ...
        "AS A RESULT, YOU CAN GET A TOTAL OF 400 COINS FROM COLLECTING ALL THE RAINBOW COINS IN THE GAME",
    ],
    [
    ...
    [
        "ON THE TOPIC OF FAKE THINGS IN DONKEY KONG 64, IT IS POSSIBLE TO GET SOMETHING CALLED 'FAKE PRODUCTION ROOM'.",
