...
extern int spawnTagBarrel(actorSpawnerData* spawner);
extern void tagFunc_0(void* player, void* player_paad);
extern void tagFunc_1(float* x, float* y, float* z, int chunk);
extern void tagFunc_2(float x, float y, float z, int chunk);
extern void tagFunc_3(void* camera);
extern void spawnTagActors(void* paad);
...
extern int TagInstrumentChannels[5];
