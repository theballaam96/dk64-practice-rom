...
.include "asm/pal/symbols.asm" // Include dk64.asm to tell armips' linker where to find the game's function(s)
.include "asm/jump_list_0.asm"
.include "asm/pal/hookdef.asm"
.include "asm/jump_list_1.asm"