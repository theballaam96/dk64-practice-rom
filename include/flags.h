#include "rom_version.h"
	...
	// Boss Intro Cutscenes
	#define FLAG_INTRO_ARMYDILLO1 0x69 // AD1
	#define FLAG_INTRO_DOGADON1 0x68 // Dog 1
	#define FLAG_INTRO_MADJACK 0x6B // MJ
	#define FLAG_INTRO_PUFFTOSS 0x6C // Puff
	#define FLAG_INTRO_DOGADON2 0x6A // Dog 2
	#define FLAG_INTRO_ARMYDILLO2 0x6E // AD2
	#define FLAG_INTRO_KINGKUTOUT 0x6D // KKO
	...
	#define FLAG_STORY_ARCADE 0x64 // Arcade Story
	#define FLAG_STORY_JETPAC 0x62 // Jetpac Story
	
	#define FLAG_KROOL_RESET_TINY 0x5D
	#define FLAG_KROOL_INTRO_TINY 0x59
	#define FLAG_KROOL_INTRO_DK 0x5E
	#define FLAG_KROOL_TOE_1 0x52
	#define FLAG_KROOL_TOE_2 0x53
	#define FLAG_KROOL_TOE_3 0x54
	#define FLAG_KROOL_TOE_4 0x55
	#define FLAG_KROOL_CUTSCENE_GORILLAGONE 0x60
#elif ROM_VERSION == 2
	// JP
	#define FLAG_WATERFALL 0x17B // Waterfall Cutscene
	#define FLAG_ESCAPE 0x187 // Escape Cutscene
	
	// Kong FTTs
	#define FLAG_FTT_DIDDY 0x170 // Diddy FTT
	#define FLAG_FTT_LANKY 0x171 // Lanky FTT
	#define FLAG_FTT_TINY 0x172 // Tiny FTT
	#define FLAG_FTT_CHUNKY 0x173 // Chunky FTT

	#define FLAG_ABILITY_CAMERA 0x17A // Camera
	#define FLAG_ABILITY_SIMSLAM 0x181 // Cranky Sim Slam Acquired
	...
	#define FLAG_WARP_AZTEC_W1_PORTAL 0x50
	#define FLAG_WARP_AZTEC_W1_CANDY 0x51
	#define FLAG_WARP_AZTEC_W2_TEMPLE 0x52
	#define FLAG_WARP_AZTEC_W2_TOTEM 0x53
	#define FLAG_WARP_AZTEC_W3_CRANKY 0x54
	#define FLAG_WARP_AZTEC_W3_TOTEM 0x55
	#define FLAG_WARP_AZTEC_W4_TOTEM 0x57
	#define FLAG_WARP_AZTEC_W4_FUNKY 0x56
	#define FLAG_WARP_AZTEC_W5_TOTEM 0x58
	#define FLAG_WARP_AZTEC_W5_SNOOP 0x3F // GB Flag

	#define FLAG_WARP_LLAMA_W1_HIGH 0x59
	#define FLAG_WARP_LLAMA_W1_LOW 0x5A
	#define FLAG_WARP_LLAMA_W2_FAR 0x5B
	#define FLAG_WARP_LLAMA_W2_LOW 0x5C	

	#define FLAG_WARP_FACTORY_W1_FOYER 0x8E
	#define FLAG_WARP_FACTORY_W1_STORAGE 0x8F
	#define FLAG_WARP_FACTORY_W2_FOYER 0x90
	#define FLAG_WARP_FACTORY_W2_RND 0x91
	#define FLAG_WARP_FACTORY_W3_FOYER 0x92
	#define FLAG_WARP_FACTORY_W3_SNIDE 0x93
	#define FLAG_WARP_FACTORY_W4_TOP 0x94
	#define FLAG_WARP_FACTORY_W4_BOTTOM 0x95
	#define FLAG_WARP_FACTORY_W5_FUNKY 0x96
	#define FLAG_WARP_FACTORY_W5_ARCADE 0x97

	#define FLAG_WARP_GALLEON_W1_LIGHTHOUSE 0xB1
	#define FLAG_WARP_GALLEON_W1_CRANKY 0xB2
	#define FLAG_WARP_GALLEON_W2_2DS 0xAC
	#define FLAG_WARP_GALLEON_W2_CRANKY 0xAD
	#define FLAG_WARP_GALLEON_W3_SNIDE 0xAE
	#define FLAG_WARP_GALLEON_W3_CRANKY 0xAF
	#define FLAG_WARP_GALLEON_W4_SEAL 0xB0
	#define FLAG_WARP_GALLEON_W4_TOWER 0xA4 // GB Flag
	#define FLAG_WARP_GALLEON_W5_5DS 0xAA
	#define FLAG_WARP_GALLEON_W5_LIGHTHOUSE 0xAB

	#define FLAG_WARP_FUNGI_W1_MILL 0xEE
	#define FLAG_WARP_FUNGI_W1_CLOCK 0xEF
	#define FLAG_WARP_FUNGI_W2_CLOCK 0xF0
	#define FLAG_WARP_FUNGI_W2_FUNKY 0xF1
	#define FLAG_WARP_FUNGI_W3_CLOCK 0xF2
	#define FLAG_WARP_FUNGI_W3_MUSH 0xF3
	#define FLAG_WARP_FUNGI_W4_CLOCK 0xF4
	#define FLAG_WARP_FUNGI_W4_OWL 0xF5
	#define FLAG_WARP_FUNGI_W5_LOW 0xF6
	#define FLAG_WARP_FUNGI_W5_HIGH 0xF7

	#define FLAG_WARP_CAVES_W1_5DI 0x11C
	#define FLAG_WARP_CAVES_W1_PORTAL 0x11D
	#define FLAG_WARP_CAVES_W2_PORTAL 0x11E
	#define FLAG_WARP_CAVES_W2_FAR 0x11F
	#define FLAG_WARP_CAVES_W3_5DI 0x124
	#define FLAG_WARP_CAVES_W3_CAVERN 0x128 // GB Flag
	#define FLAG_WARP_CAVES_W4_FAR 0x120
	#define FLAG_WARP_CAVES_W4_5DI 0x121
	#define FLAG_WARP_CAVES_W5_5DC 0x122
	#define FLAG_WARP_CAVES_W5_PILLAR 0x123

	#define FLAG_WARP_CASTLE_W1_HUB 0x148
	#define FLAG_WARP_CASTLE_W1_FAR 0x149
	#define FLAG_WARP_CASTLE_W2_HUB 0x14A
	#define FLAG_WARP_CASTLE_W2_HIGH 0x14B
	#define FLAG_WARP_CASTLE_W3_HUB 0x14C
	#define FLAG_WARP_CASTLE_W3_HIGH 0x14D
	#define FLAG_WARP_CASTLE_W4_HUB 0x14E
	#define FLAG_WARP_CASTLE_W4_HIGH 0x14F
	#define FLAG_WARP_CASTLE_W5_HUB 0x150
	#define FLAG_WARP_CASTLE_W5_HIGH 0x151

	#define FLAG_WARP_CRYPT_W1_CLOSE 0x152
	#define FLAG_WARP_CRYPT_W1_FAR 0x153
	#define FLAG_WARP_CRYPT_W2_CLOSE 0x154
	#define FLAG_WARP_CRYPT_W2_FAR 0x155
	#define FLAG_WARP_CRYPT_W3_CLOSE 0x156
	#define FLAG_WARP_CRYPT_W3_FAR 0x157

	#define FLAG_WARP_LOBBY_W1_NEAR 0x1A2
	#define FLAG_WARP_LOBBY_W1_FAR 0x1A3

	#define FLAG_WARP_ISLES_W1_RING 0x1B2
	#define FLAG_WARP_ISLES_W1_FAR 0x1B3
	#define FLAG_WARP_ISLES_W2_RING 0x1B4
	#define FLAG_WARP_ISLES_W2_FAR 0x1B5
	#define FLAG_WARP_ISLES_W3_RING 0x1B6
	#define FLAG_WARP_ISLES_W3_FAR 0x1B7
	#define FLAG_WARP_ISLES_W4_RING 0x1B8
	#define FLAG_WARP_ISLES_W4_HIGH 0x1B9
	#define FLAG_WARP_ISLES_W5_RING 0x1BA
	#define FLAG_WARP_ISLES_W5_FAR 0x1BB

	#define FLAG_WARP_HELM_W1_NEAR 0x306
	#define FLAG_WARP_HELM_W1_FAR 0x307

	#define FLAG_CUTSCENE_DIDDYHELPME 0x2A // Diddy Help Me Cutscene
	#define FLAG_CUTSCENE_LLAMA 0x5D // Llama Cutscene
	#define FLAG_CUTSCENE_KOSHA 0x12C // GK Cutscene

	#define FLAG_FTT_BLOCKER 0x17F // B Locker FTT
	#define FLAG_FTT_BANANAPORT 0x164 // Bananaport FTT
	#define FLAG_FTT_CROWNPAD 0x167 // Crown Pad FTT

	// Barrel Ability FTTs
	#define FLAG_FTT_STRONGKONG 0x16C // SK FTT
	#define FLAG_FTT_ORANGSPRINT 0x16B // OSS FTT
	#define FLAG_FTT_MINIMONKEY 0x169 // MM FTT
	#define FLAG_FTT_HUNKYCHUNKY 0x19A // HC FTT

	// Keys in Possession
	#define FLAG_KEYHAVE_KEY1 0x1A // Key 1 Have
	#define FLAG_KEYHAVE_KEY2 0x4B // Key 2 Have
	#define FLAG_KEYHAVE_KEY3 0x8B // Key 3 Have
	#define FLAG_KEYHAVE_KEY4 0xA9 // Key 4 Have
	#define FLAG_KEYHAVE_KEY5 0xED // Key 5 Have
	#define FLAG_KEYHAVE_KEY6 0x125 // Key 6 Have
	#define FLAG_KEYHAVE_KEY7 0x13E // Key 7 Have
	#define FLAG_KEYHAVE_KEY8 0x17D // Key 8 Have

	// Keys turned in/japes
	#define FLAG_KEYIN_JAPES 0x1BC // Japes Open
	#define FLAG_KEYIN_KEY1 0x1BD // Key 1 In
	#define FLAG_KEYIN_KEY2 0x1BE // Key 2 In
	#define FLAG_KEYIN_KEY3 0x1BF // Key 3 In
	#define FLAG_KEYIN_KEY4 0x1C0 // Key 4 In
	#define FLAG_KEYIN_KEY5 0x1C1 // Key 5 In
	#define FLAG_KEYIN_KEY6 0x1C2 // Key 6 In
	#define FLAG_KEYIN_KEY7 0x1C3 // Key 7 In
	#define FLAG_KEYIN_KEY8 0x1C4 // Key 8 In

	// Kongs Freed
	#define FLAG_KONG_DK 0x182 // DK Free
	#define FLAG_KONG_DIDDY 0x6 // Diddy Free
	#define FLAG_KONG_LANKY 0x47 // Lanky Free
	#define FLAG_KONG_TINY 0x43 // Tiny Free
	#define FLAG_KONG_CHUNKY 0x76 // Chunky Free
	...
	// Level Intros
	#define FLAG_INTRO_JAPES 0x1B // Japes
	#define FLAG_INTRO_AZTEC 0x60 // Aztec
	#define FLAG_INTRO_FACTORY 0x8D // Factory
	#define FLAG_INTRO_GALLEON 0xC3 // Galleon
	#define FLAG_INTRO_FUNGI 0x102 // Fungi
	#define FLAG_INTRO_CAVES 0x11B // Caves
	#define FLAG_INTRO_CASTLE 0x15E // Castle

	// Level T&S Portal Closed
	#define FLAG_PORTAL_JAPES 0x2E // Japes
	#define FLAG_PORTAL_AZTEC 0x6D // Aztec
	#define FLAG_PORTAL_FACTORY 0x99 // Factory
	#define FLAG_PORTAL_GALLEON 0xCC // Galleon
	#define FLAG_PORTAL_FUNGI 0x103 // Fungi
	#define FLAG_PORTAL_CAVES 0x12F // Caves
	#define FLAG_PORTAL_CASTLE 0x161 // Castle
	...
	#define FLAG_MODIFIER_FUNGINIGHT 0xCF // Fungi Time of Day
	#define FLAG_MODIFIER_KOSHADEAD 0x12D // Giant Kosha Dead
	#define FLAG_MODIFIER_HELMBOM 0x303 // Helm BoM Off

	// Training Barrel Flags
	#define FLAG_TBARREL_DIVE 0x183 // Dive
	#define FLAG_TBARREL_ORANGE 0x185 // Orange
	#define FLAG_TBARREL_BARREL 0x186 // Barrel
	#define FLAG_TBARREL_VINE 0x184 // Vine
	#define FLAG_TBARREL_COMPLETE 0x188 // Training Barrels Completed
	#define FLAG_TBARREL_SPAWNED 0x180 // Training Barrel Spawned
