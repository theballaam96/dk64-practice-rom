...
/* Response fields */
static inline unsigned int sd_r1_cs(const void *resp)
{
  unsigned int cs = 0;
...
static inline unsigned int r3_ocr(const void *resp)
{
  unsigned int ocr = 0;
...
static inline unsigned int r6_rca(const void *resp)
{
  unsigned int rca = 0;
...
static inline unsigned int r6_status(const void *resp)
{
  unsigned int st = 0;
...
static inline unsigned int swfn_pow(const void *dat)
{
  unsigned int pow = 0;

  const unsigned char *p = dat;
  pow = (pow << 8) | *p++;
  pow = (pow << 8) | *p++;
...
static inline unsigned int swfn_sup(const void *dat, int group)
{
  unsigned int sup = 0;
...
static inline unsigned int swfn_sel(const void *dat, int group)
{
  const unsigned char *p = dat;
  p += 17 - ((group + 1) >> 1);
  if (group & 1)
...
static inline unsigned int swfn_ver(const void *dat)
{
  const unsigned char *p = dat;
  return p[17];
}

static inline unsigned int swfn_bsy(const void *dat, int group)
{
  unsigned int bsy = 0;
